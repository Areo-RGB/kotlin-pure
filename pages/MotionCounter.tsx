      ...
      <Header
        ...
        rightElement={
          <Button
            ...
            className={`bg-black/50 backdrop-blur-md border-gray-700 pointer-events-auto transition-colors ${
              showSettings
        ...
        {!showSettings && (
          <div className="absolute inset-0 z-20 flex flex-col items-center justify-center pointer-events-none">
            <div className="flex flex-col items-center">
              <div
                className={`text-9xl font-mono font-bold tabular-nums tracking-tighter drop-shadow-2xl transition-all duration-100 ${
              ...
              <div
                className={`mt-4 px-3 py-1 rounded border border-white/20 backdrop-blur-sm text-xs font-bold uppercase tracking-[0.2em] ${
                  isArmed
      ...
      >
        <div className="">
          ...
          <p className="text-[10px] text-gray-500 mt-2">
            Prevents double counting. Increase if getting multiple counts for
            one object.
          </p>
        </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <div className="text-[10px] text-gray-500">
                  {useWebGL ? "GPU-accelerated (faster)" : "CPU fallback"}
                </div>
              </div>
            </div>
            <div
              className={`w-12 h-6 rounded-full transition-colors flex items-center px-1 ${
                useWebGL ? "bg-emerald-500" : "bg-gray-600"
              }`}
            >
              <div
                className={`w-4 h-4 rounded-full bg-white transition-transform ${
                  useWebGL ? "translate-x-6" : "translate-x-0"
                }`}
              />
            </div>
          </button>
