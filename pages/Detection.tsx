      ...
      <div className="relative flex-1 w-full h-full bg-gray-900">
        ...
        {!showSettings && (
          <div className="absolute inset-0 z-20 flex flex-col items-center justify-center pointer-events-none">
            <div
              className={`text-6xl font-mono font-bold tabular-nums tracking-tighter drop-shadow-2xl ${
            ...
            <div
              className={`mt-2 text-sm uppercase tracking-[0.2em] font-bold ${
                isRecording
                ...
                >
                  <div className="max-h-48 overflow-y-auto p-2 space-y-1 custom-scrollbar">
                    ...
                    {history.map((entry, index) => (
                      <div
                        key={entry.id}
                        className="flex items-center justify-between bg-gray-900/50 p-2 rounded border border-gray-700/50"
                      >
